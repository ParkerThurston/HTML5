...
function Game() {
    document.write("Maze ___");
    var playerName = prompt("What is your name?");
    alert("Welcome to the maze "+playerName);
    Start();
    function Start() {
        var start = prompt("You wake up...You take a look around and realize you have no memory. You... /n-look around /n- go back to sleep /n think").toLowerCase();
        if(start == "look around" || start == "look"){
            ...
            if(resume) {
                ...
                var startSleep = prompt("Now in the dark you are back at the start. The options are the same /n -go back to sleep /n -look around /n -think.").toLowerCase;
            }
            else{
